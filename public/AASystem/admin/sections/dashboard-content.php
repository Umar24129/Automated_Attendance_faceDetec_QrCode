			...
			<div class="col-md-10" style="left: 17%;">
				<?php 
					...
					if(isset($_GET['section-id']))
					{
						...
						elseif ($section=="register-student") {
							include "register-students.php";
						}
						elseif ($section=="student-subject") {
							include "select-subjects-for-student.php";
						}
						elseif ($section=="delete-teacher") {
							include "delete-teacher.php";
						}
						elseif ($section=="delete-student") {
							include "delete-student.php";
						}
						elseif ($section=="update-teacher") {
							include "update-teacher.php";
						}
						elseif ($section=="update-student") {
							include "update-student.php";
						}
						elseif ($section=="delete-course") {
							include "delete-course.php";
						}
